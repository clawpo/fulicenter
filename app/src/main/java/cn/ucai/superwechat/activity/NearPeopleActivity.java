...
import cn.ucai.superwechat.utils.ImageLoader.OnImageLoadListener;
...
public class NearPeopleActivity extends BaseActivity {
    public static final String TAG = "NearPeopleActivity";
    ...
    protected void onCreate(Bundle arg0) {
        ...
        mInstance=this;
        mlvNearPeople=getViewById(R.id.lvNearPeople);
        Log.e(TAG,"NearPropleAvtivity.onCreate....");
    ...
    class MyLocationListener implements BDLocationListener{
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            Log.e("main","user="+user);
            new UploadLocationTask(user).execute();
        }
    ...
    class NearPeopleAdapter extends BaseAdapter{
        ...
        public NearPeopleAdapter(Context context, ArrayList<UserBean> users) {
            ...
            myUser=SuperWeChatApplication.getInstance().getUserBean();
        ...
        private ArrayList<NearUserBean> createNearUsers(ArrayList<UserBean> users, UserBean myUser) {
        ...
        public View getView(int position, View convertView, final ViewGroup parent) {
            ...
            holder.tvNick.setText(user.getUser().getNick());
            holder.tvDistance.setText(user.getDistance()+"米");
            
            String path=I.DOWNLOAD_AVATAR_URL+user.getUser().getAvatar();
            holder.ivAvatar.setTag(path);
            Bitmap avatar = imageLoader.displayImage(path, user.getUser().getUserName()+".jpg", 80, 80, new OnImageLoadListener() {
                @Override
    ...
    class UploadLocationTask extends AsyncTask<Void, Void, Boolean>{
        ...
        protected Boolean doInBackground(Void... params) {
            Log.e(TAG,"NearPropleAvtivity.UploadLocationTask.doInBackground...user="+user);
           boolean isSuccess = NetUtil.uploadLocation(user);
           if(isSuccess){
    ...
    class DownloadLocationTask extends AsyncTask<Void, Void, ArrayList<UserBean>>{
        ...
        protected ArrayList<UserBean> doInBackground(Void... params) {
            ...
            ArrayList<UserBean> users=NetUtil.downloadLocation(userName, mPageId, PAGE_SIZE);
            return users;
        }
        @Override
