...
public class AddContactActivity extends BaseActivity{
                       ...
                       try {
                        ...
                        runOnUiThread(new  Runnable() {
                            public void run() {
                                ...
                                Utils.showToast(mContext, s2+e.getMessage(), 1);
                            }
                        });
                    } 
                    }
    ...
    private void setSearchContactClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getString(R.string.button_search).equals(saveText)){
                    ...
                    if(TextUtils.isEmpty(name)){
                        String str = getResources().getString(R.string.Please_enter_a_username);
                        startActivity(new Intent(mContext,AlertDialog.class).putExtra("msg", str));
                        return;
                    }
                    //如果已是好友，则提示已是好友
                    ...
                    user.setUserName(toAddUsername);
                    if(contactList.contains(user)){
                        Utils.showToast(mContext, R.string.This_user_is_already_your_friend, Toast.LENGTH_SHORT);
                        return;
                    }
