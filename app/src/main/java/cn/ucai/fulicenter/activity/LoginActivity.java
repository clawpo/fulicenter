...
//			getUser();
		...
		if (FuLiCenterApplication.getInstance().getUserName() != null) {
			metUserName.setText(FuLiCenterApplication.getInstance().getUserName());
		}
	}
            ...
            public void onClick(View v) {
                ...
                EMChatManager.getInstance().login(mUserName, mPassword, new EMCallBack() {
                    ...
                    public void onSuccess() {
                        ...
                        // 登陆成功，保存用户名密码
                        FuLiCenterApplication.getInstance().setUserName(mUserName);
                        FuLiCenterApplication.getInstance().setPassword(mPassword);
...
//						startActivity(intent);
    ...
    private void saveUser(UserBean user) {
        FuLiCenterApplication instanceApplication = FuLiCenterApplication.getInstance();
	...
	private void getUser(){
		...
		Log.e(TAG,"LoginActivity.getUser.username="+ FuLiCenterApplication.getInstance().getUserName());
		Log.e(TAG,"LoginActivity.getUser.password="+ FuLiCenterApplication.getInstance().getPassword());
//		if(user!=null){
//
//		}else{
//
