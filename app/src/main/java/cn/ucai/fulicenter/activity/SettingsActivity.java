...
public class SettingsActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null && savedInstanceState.getBoolean("isConflict", false))
            return;
        rl_switch_notification = (RelativeLayout) getViewById(R.id.rl_switch_notification);
        rl_switch_sound = (RelativeLayout) getViewById(R.id.rl_switch_sound);
        rl_switch_vibrate = (RelativeLayout) getViewById(R.id.rl_switch_vibrate);
        rl_switch_speaker = (RelativeLayout) getViewById(R.id.rl_switch_speaker);
        rl_switch_chatroom_leave = (RelativeLayout) getViewById(R.id.rl_switch_chatroom_owner_leave);

        iv_switch_open_notification = (ImageView) getViewById(R.id.iv_switch_open_notification);
        iv_switch_close_notification = (ImageView) getViewById(R.id.iv_switch_close_notification);
        iv_switch_open_sound = (ImageView) getViewById(R.id.iv_switch_open_sound);
        iv_switch_close_sound = (ImageView) getViewById(R.id.iv_switch_close_sound);
        iv_switch_open_vibrate = (ImageView) getViewById(R.id.iv_switch_open_vibrate);
        iv_switch_close_vibrate = (ImageView) getViewById(R.id.iv_switch_close_vibrate);
        iv_switch_open_speaker = (ImageView) getViewById(R.id.iv_switch_open_speaker);
        iv_switch_close_speaker = (ImageView) getViewById(R.id.iv_switch_close_speaker);
        ...
        llDiagnose=(LinearLayout) getViewById(R.id.ll_diagnose);
        pushNick=(LinearLayout) getViewById(R.id.ll_set_push_nick);
