 ...
 *
 */
public class OnSetAvatarListenerRS implements View.OnClickListener {
     ...
     */
    public OnSetAvatarListenerRS(Activity mActivity, int parentId, String userName, String avatarType) {
        //成员变量赋值
